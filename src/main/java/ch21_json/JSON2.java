...
public class JSON2 {
    public static void main(String[] args) {
        Gson gson = new Gson();     // 아까라 다르게 그냥 Gson 인스터스를 만들었습니다
    ...
    // 1-1. 위에 클래스 정의했으니까 setter 정의해서 집어넣는 방법이 있겠습니다
        ...
        // 1-3 근데 생성하면서 동시에 속성값 넣고 싶은면 @AllArgsConstructor
      ...
      // 그럼 생성된 user1 인스턴스를 가지고 Json 데이터로 바꿀겁니다.
        ...
        // JSonObject를 활용하여 studentCode 2025001 / studenName 김이 / studentYear 2 / score 96.7인 객체를 생성하시오.
        // 참고로 key value 다 String으로 집어놓겠습니다.
    ...
    // 3. Map -> Json 데이터로
        /*
            ...
            productName 삼성 갤러시북 프로 5
            라는 Entry(key-value pair)를 입력하시오.

            gson 및 gsonBuilder를 활용하여 json 데이터로 바꿀겁니다.
         */

        Map<String,String> map1 = new HashMap();
        map1.put("productcode"," NT960XHA-KD72G");
        map1.put("productName","갤러시북 프로 5");
