...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("변형 :"+(int)cast2);      // 소문자의 경우는 대문자만큼은 출데되지않지만
                                                        // 외워야 될 필요는 있습니다.
        // 업개스팅 방법 #2
        char cast3='b';
        ...
        System.out.println("원형 :"+cast3);
            ...
            // 다운캐스팅 파트
        int cast4=99;           //애는 #1 방법으로,
        int cast5=100;             //애는 #2 방법으로 처리하시오.
