...
//
//        System.out.println(animalData1);
//        System.out.println(animalData2);
//        System.out.println(animalData3);

        /*
            29번 라인에서 오류가 생긴다는 점을 확인할 수 있습니다.
        ...
        // 이상의 코드를 작성했을 때 성성자를 통해서 객체 생성을 하지 않았다는 점,
        // 저희가 직접 getAnimal
