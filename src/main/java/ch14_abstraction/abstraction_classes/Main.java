...
public class Main {
    public static void main(String[] args) {
        ...
        phoneFactory1.setName("애플 스마트론 공장");      // 부모 메서드 사용
        ...
        // 그렇다면 일반적인 클래스르를 기준으로 봤을 때 메서드를 정의한 부분까지 작성했다고 볼 수 있겠습니다.
        factory1.setName("가진 제품 공장");   // 이건 메서드 호출에 해당하겠죠.
        factory1.produce("백색 가전");  // 애도.
        /*
