...
public class Constructor {
    ...
    Constructor() {
        ...
        this.num = number;     // argument로 받은 int 자료형의 데이터를 이 클래스의 필드인
            ...
            // 매개변수 생성자 # 2
            Constructor(String title){        // 추후에는 매개변수명과 속성명을 일치기킬겁니다.
                this.name = title;
                System.out.println("String 메개변수를 필수로 요구하는 매개변수 생성자로 객체를 생성");
                System.out.println("RequiredArgsConstructor");
            }
        // 매개변수 생성자 # 3
