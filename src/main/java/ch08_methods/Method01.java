...
// 2. [ o | x ]
    ...
    public static String introdusce(String name, int age){
...
//        result = "대입 불가";
        call3();        // 이거 실행이 안돼요.
        System.out.println(call3());        // call3()는 출력하려는 명령문이 메서드 내에 정의되어있지 않음
            // 이상을 이유로 sout이 main단계에서 요구됨.

        System.out.println( call4(2024,4,24,"목요일"));

        System.out.println(introdusce("김민효",22));
       ...
       String introduction = introdusce(name,age);
        ...
        /*
              함수형 프로그래밍(Functional Programming) :
                ...
                이상의 예시에서는 .nextLine()의 결과값과 .nextInt()으 결과값이
